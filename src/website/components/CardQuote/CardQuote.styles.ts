...
export const CardQuoteWrapper = styled('div')(
  ({ theme }) => css`
    display: flex;
...
export const CardQuoteItem = styled('div')(
  ({ theme }) => css`
    display: flex;
    flex-direction: column;
...
export const CardQuoteTitle = styled('div')(
  ({ theme }) => css`
...
export const CardQuoteSubtitle = styled('div')(
  ({ theme }) => css`
    text-align: center;
  `,
)

export const CardBlockQuote = styled('div')(
  ({ theme }) => css`
    ...
    &:before {
      ...
      border-right: 15px solid ${theme.colors.grey.light};
      position: absolute;
      left: -15px;
    }
  `,
